	...
	*/
	return (
		<>
			...
			<img className="chickenImg" src="../public/chicken.png"/>
			<img className="tacoImg" src="../public/taco.png"/>
			<img className="chocolateImg" src="../public/chocolate.png"/>
			<img className="sugarImg" src="../public/sugar.png"/>
